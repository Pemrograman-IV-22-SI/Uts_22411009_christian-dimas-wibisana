          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                border: OutlineInputBorder(), labelText: 'Masukan Nama'),
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                border: OutlineInputBorder(), labelText: 'Masukan Kode Barang'),
                keyboardType: TextInputType.text,
              ),
              const SizedBox(
                height: 8,
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                border: OutlineInputBorder(), labelText: 'Masukan Nama Barang'),
                keyboardType: TextInputType.text,
              ),const SizedBox(
                height: 8,
              ),
              ...
              TextField(
                controller: txtHarga,
                decoration: const InputDecoration(
                    border: OutlineInputBorder(), labelText: 'Masukan Harga'),
                keyboardType: TextInputType.text,
              ),const SizedBox(
                height: 8,
              ),
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                    border: OutlineInputBorder(), labelText: 'Masukan Stock Barang'),
                keyboardType: TextInputType.text,
              ),
              const SizedBox(
                height: 8,
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                    border: OutlineInputBorder(), labelText: 'Masukan Jumlah Beli'),
                keyboardType: TextInputType.text,
              ),
              const SizedBox(
                height: 12,
